...
const kUserKey = "OGE5MTA3NTctZWEyMi00ZTY0LWI5ZmEtNTkwMjlhNWMxY2Iz";
const kAPIKey = "NjIzM2RhZTEtOTJlZi00YzhjLTk5MmItZDZjMjRlNDVhNGMy";
...
exports.addUser = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const createdUser = await client.createUser(
      "d7eb1b0c-fc47-4f10-911a-5127dd27746e",
      user,
    );
