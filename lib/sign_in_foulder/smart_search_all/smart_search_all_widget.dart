      ...
      if (_model.query?.length == 0) {
        await UpsertVectorsNeightnCall.call(
          upsertText: functions.stringToAPI(
              'Name: ${currentUserDisplayName}, Email: ${currentUserEmail}, firebase_id: ${currentUserUid}, type: person'),
          ownerType: 'user',
            ...
            await DocumentsTable().update(
              ...
              matchingRows: (rows) => rows.eq(
                ...
                functions.stringToAPI(
                    'Name: ${currentUserDisplayName}, Email: ${currentUserEmail}, firebase_id: ${currentUserUid}'),
              ),
            );
          }(),
        );
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Builder(
              builder: (context) {
                if (((currentUserDocument?.smartSearchHistory?.toList() ?? [])
                            .length !=
                        0) ||
                    true) {
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('smart_search_all_3');
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                                    mainAxisAlignment:
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  Text(
                                                                                    historyItem.title.maybeHandleOverflow(
                                                                                      maxChars: 14,
                                                                                      replacement: '…',
                                                                                    ),
                                                                                  ...
                                                                                  Opacity(
                                                                                    opacity: 0.5,
                                                                                    child: Text(
                                                                                      dateTimeFormat("relative", historyItem.smartsearchItems.first.when!),
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: 'LTSuperior',
                                                                                            fontSize: 12.0,
                                                                                            letterSpacing: 0.0,
                                                                        ...
                                                                        FlutterFlowIconButton(
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            _model.removeFromHistorySmartSearch(historyItem);
                                                                            safeSetState(() {});
                                                                            unawaited(
                                                                              () async {
                                                                                  ...
                                                                                  ...mapToFirestore(
                                                                                    {
                                                                                      'smartSearchHistory': FieldValue.arrayRemove([
                                                                                        getSmartsearchSessionFirestoreData(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Opacity(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        dateTimeFormat(
                                                                            "relative",
                                                                            (currentUserDocument?.smartSearchHistory?.toList() ?? []).first.smartsearchItems.first.when!),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              fontFamily: 'LTSuperior',
                                                          ...
                                                          FlutterFlowIconButton(
                                                            ...
                                                            onPressed:
                                                                () async {
                                                              _model.removeFromHistorySmartSearch(
                                                                  (currentUserDocument
                                                                              ?.smartSearchHistory
                                                                              ?.toList() ??
                                                                          [])
                              ...
                              if (_model.chosenState == 'All') {
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              child:
                                                                ...
                                                                key: Key(
                                                                    'Keyef6_${listViewIndex}_of_${_model.listViewPagingController2!.itemList!.length}'),
                                                                event:
                                                                    listViewEventsRecord,
                                                              ),
                                                            ),
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return InkWell(
                                                            ...
                                                            child:
                                                                UsercardSmallWidget(
                                                              key: Key(
                                                                  'Keye7v_${listViewIndex}_of_${listViewUsersRecordList.length}'),
                                                              user:
                                                                  listViewUsersRecord,
                                                              teamEdit: false,
                                                              isWaiting: false,
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return Container(
                                                            decoration:
                                                                BoxDecoration(),
                                                            child:
                                                                ProductCardSmallWidget(
                                                              key: Key(
                                                                  'Keymda_${listViewIndex}_of_${listViewProductsRecordList.length}'),
                                                              parameter1:
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child:
                                                              ...
                                                              key: Key(
                                                                  'Key9ua_${listViewIndex}_of_${listViewProjectsRecordList.length}'),
                                                              parameter2:
                                        ...
                                        return Visibility(
                                          visible: (listViewEventsRecord
                                                  ...
                                                  listViewEventsRecord
                                                          .eventInfo.title !=
                                                      '') &&
                                              (listViewEventsRecord.eventInfo
                                                          .description !=
                                                      null &&
                                                  listViewEventsRecord.eventInfo
                                                          .description !=
                                          ...
                                          child: EventCardWidget(
                                            key: Key(
                                                'Keyjbr_${listViewIndex}_of_${_model.listViewPagingController6!.itemList!.length}'),
                                    ...
                                    builderDelegate:
                                      ...
                                      itemBuilder: (context, _, listViewIndex) {
                                        ...
                                        return UserCardNewWidget(
                                          key: Key(
                                              'Key76w_${listViewIndex}_of_${_model.listViewPagingController7!.itemList!.length}'),
                                ...
                                return Padding(
                                  ...
                                  child: PagedListView<
                                    ...
                                    pagingController:
                                        _model.setListViewController8(
                                      ProjectsRecord.collection.where(
                                        'main_image',
                                        isNotEqualTo: null,
                                      ),
                                    ),
                                    ...
                                    builderDelegate: PagedChildBuilderDelegate<
                                      ...
                                      itemBuilder: (context, _, listViewIndex) {
                                        ...
                                        return CompanyCardWidget(
                                          key: Key(
                                              'Keynff_${listViewIndex}_of_${_model.listViewPagingController8!.itemList!.length}'),
                                    ...
                                    builderDelegate: PagedChildBuilderDelegate<
                                      ...
                                      itemBuilder: (context, _, listViewIndex) {
                                        ...
                                        return ProductCardWidget(
                                          key: Key(
                                              'Keyvsl_${listViewIndex}_of_${_model.listViewPagingController9!.itemList!.length}'),
                                          isFrom: 'Smart Search',
