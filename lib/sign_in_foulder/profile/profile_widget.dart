...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.images3 = _model.images4 != null && (_model.images4)!.isNotEmpty
          ? _model.images4!
          : (currentUserDocument?.images?.toList() ?? [])
              .toList()
              .cast<String>();
      safeSetState(() {});
      _model.chosen = widget!.chosen!;
      safeSetState(() {});
    });
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (((currentUserDocument?.subscribers?.toList() ?? [])
                            .isNotEmpty) ||
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          (currentUserDocument?.subscribers
                                                          ?.toList() ??
                                                      [])
                                                  .isNotEmpty
                                              ? '${(currentUserDocument?.subscribers?.toList() ?? []).length.toString()} subscribers'
                                              : '${(currentUserDocument?.subscriptions?.toList() ?? []).length.toString()} subscriptions',
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: ImageSliderWidget(
                                                                                images: functions.reverseImagesList(_model.images3.toList())!,
                                                                                initialindex: imagesIndex,
                                                                                user: _model.user3,
                                                                                isThisYours: true,
                                                                                actionDelete: (images) async {
                                                                                  _model.images3 = functions.reverseImagesList(images?.toList())!.toList().cast<String>();
                                                                                  safeSetState(() {});
                                                                                },
                                                                              ),
                                                                            ),
