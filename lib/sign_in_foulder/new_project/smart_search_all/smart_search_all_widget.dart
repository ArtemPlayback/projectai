                                                                  ...
                                                                  ...mapToFirestore(
                                                                    {
                                                                      'smartSearchHistory':
                                                                        ...
                                                                        getSmartSearchFirestoreData(
                                                                          updateSmartSearchStruct(
                                                                            (currentUserDocument?.smartSearchHistory?.toList() ?? []).first,
                                                                            clearUnsetFields:
                                                                                false,
                                                                          ),
                                                                          true,
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          child:
                                                            ...
                                                            key: Key(
                                                                'Key1pv_${listViewIndex}_of_${_model.listViewPagingController2!.itemList!.length}'),
                                                            event:
                                                                listViewEventsRecord,
                                                          ),
                                                        ),
                                                      ...
                                                      itemBuilder: (context, _,
                                                        ...
                                                        return InkWell(
                                                          ...
                                                          child:
                                                              UsercardSmallWidget(
                                                            key: Key(
                                                                'Keye7v_${listViewIndex}_of_${_model.listViewPagingController3!.itemList!.length}'),
                                                            user:
                                                                listViewUsersRecord,
                                                            actionEdit:
                                                                () async {},
                                                      ...
                                                      itemBuilder: (context, _,
                                                        ...
                                                        return Container(
                                                          ...
                                                          child:
                                                            ...
                                                            key: Key(
                                                                'Keymda_${listViewIndex}_of_${_model.listViewPagingController4!.itemList!.length}'),
                                                            parameter1:
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child:
                                                              ...
                                                              key: Key(
                                                                  'Key9ua_${listViewIndex}_of_${_model.listViewPagingController5!.itemList!.length}'),
                                                              parameter2:
