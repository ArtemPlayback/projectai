...
class _ChatsWidgetState extends State<ChatsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.chats3 = _model.chats3.toList().cast<ChatsRecord>();
      setState(() {});
    });
                                                                      ...
                                                                      children: [
                                                                                    ...
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        containerVarItem.chatMessages.last.type == 'image'
                                                                                            ...
                                                                                            : (containerVarItem.chatMessages.last.type == 'audio' ? 'voice message' : containerVarItem.chatMessages.last.text).maybeHandleOverflow(
                                                                                                maxChars: 25,
                                                                                                replacement: '…',
                                                                                              ),
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            if (containerVarItem.chatMessages.where((e) => (e.from != currentUserReference) && (e.isRead == false)).toList().length !=
                                                                                0)
                                                                              Padding(
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      crossAxisAlignment:
                                                                          CrossAxisAlignment
                                                                              .end,
                                                                      children: [
                                                                        if (containerVarItem.notifications.where((e) => e.isSeen).toList().length !=
                                                                            0)
                                                                          Padding(
                                                                            padding: EdgeInsetsDirectional.fromSTEB(
                                                                                0.0,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Align(
                                                                                alignment: AlignmentDirectional(0.0, 0.0),
                                                                                child: Text(
                                                                                  containerVarItem.notifications.where((e) => e.isSeen).toList().length.toString(),
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: 'Manrope',
                                                                                        color: Colors.white,
                                                                                        fontSize: 11.0,
