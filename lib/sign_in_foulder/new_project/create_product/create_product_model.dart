...
class CreateProductModel extends FlutterFlowModel<CreateProductWidget> {
  ...
  void addToFakeImages(String item) => fakeImages.add(item);
  void removeFromFakeImages(String item) => fakeImages.remove(item);
  void removeAtIndexFromFakeImages(int index) => fakeImages.removeAt(index);
  void insertAtIndexInFakeImages(int index, String item) =>
      fakeImages.insert(index, item);
  void updateFakeImagesAtIndex(int index, Function(String) updateFn) =>
      fakeImages[index] = updateFn(fakeImages[index]);
