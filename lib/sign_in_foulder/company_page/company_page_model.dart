...
class CompanyPageModel extends FlutterFlowModel<CompanyPageWidget> {
  ...
  List<String> images5 = [];
  void addToImages5(String item) => images5.add(item);
  void removeFromImages5(String item) => images5.remove(item);
  void removeAtIndexFromImages5(int index) => images5.removeAt(index);
  void insertAtIndexInImages5(int index, String item) =>
      images5.insert(index, item);
  void updateImages5AtIndex(int index, Function(String) updateFn) =>
      images5[index] = updateFn(images5[index]);
