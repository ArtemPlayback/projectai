  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.subscribed = (currentUserDocument?.subscriptions?.toList() ?? [])
              .where((e) => e.company == widget!.company?.reference)
              .toList()
              .length >
          0;
      _model.images5 = widget!.company!.images.toList().cast<String>();
      safeSetState(() {});
      await Future.wait([
        Future(() async {
          ...
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if ((widget!.company!.subscriptions.isNotEmpty) ||
                      (widget!.company!.subscribers.isNotEmpty))
                    Padding(
                      padding:
                            ...
                            child: Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '${widget!.company?.subscribers?.length?.toString()} subscribers',
                                ...
                                wrapWithModel(
                                  ...
                                  child: SubscribersMiniWidget(
                                    listUsers: widget!.company!.subscribers
                                        .map((e) => e.user)
                                        .withoutNulls
                                        .toList(),
                                  ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                if ((widget!.company?.projectInformation
                                                ?.description ==
                                            null ||
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      if (widget!.company?.events != null &&
                                          (widget!.company?.events)!.isNotEmpty)
                                        InkWell(
                                          splashColor: Colors.transparent,
                                          focusColor: Colors.transparent,
                                          hoverColor: Colors.transparent,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: ImageSliderWidget(
                                                                                images: functions.reverseImagesList(widget!.company?.images?.toList())!,
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(
                                                                ...
                                                                0.0),
                                                    child: Text(
                                                      '${widget!.company?.title} haven\'t added any images yet',
                                                      textAlign:
                                                          TextAlign.center,
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemBuilder: (context, postsIndex) {
                                          ...
                                          return PostCardWidget(
                                            ...
                                            isAuthUser: widget!.company?.user ==
                                                currentUserReference,
                                            post: postsItem,
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        120.0, 5.0, 120.0, 0.0),
                                                child: Text(
                                                  '${widget!.company?.title} haven\'t added any posts yet',
            ...
            Row(
              ...
              children: [
                ...
                if (widget!.company?.reference != currentUserReference)
                  Padding(
                    padding:
                      ...
                      builder: (context) => wrapWithModel(
                        ...
                        child: ToggleWidget(
                          boolean: (currentUserDocument?.saved?.toList() ?? [])
                                  .where((e) =>
                                      e.people == widget!.company?.reference)
                                  .toList()
                                  .length >
                              0,
                          toggleOn: () async {
