...
import 'investments_copy_model.dart';
export 'investments_copy_model.dart';

class InvestmentsCopyWidget extends StatefulWidget {
  const InvestmentsCopyWidget({
    super.key,
    this.invstmentsFrom,
  ...
  @override
  State<InvestmentsCopyWidget> createState() => _InvestmentsCopyWidgetState();
}

class _InvestmentsCopyWidgetState extends State<InvestmentsCopyWidget> {
  late InvestmentsCopyModel _model;
