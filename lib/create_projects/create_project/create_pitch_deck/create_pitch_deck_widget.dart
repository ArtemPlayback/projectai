...
import 'create_pitch_deck_model.dart';
export 'create_pitch_deck_model.dart';

class CreatePitchDeckWidget extends StatefulWidget {
  const CreatePitchDeckWidget({
    super.key,
  ...
  @override
  State<CreatePitchDeckWidget> createState() => _CreatePitchDeckWidgetState();
}

class _CreatePitchDeckWidgetState extends State<CreatePitchDeckWidget> {
  late CreatePitchDeckModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatePitchDeckModel());
          ...
          child: Stack(
            children: [
                                                  ...
                                                  child: ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            20.0),
                                                    child: Image.asset(
                                                      'assets/images/Frame_1948755063.png',
                                                      width: 300.0,
                                                      height: 200.0,
                                                      fit: BoxFit.cover,
                                                    ),
                                ...
                                children: [
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Here you can insert screens of your application',
                                                          textAlign:
                                                              TextAlign.start,
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'You can insert several rectangular images',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'You can insert one rectangular image',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        } else if (_model.firstImagesType ==
                                            'gallery') {
                                          return Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'Briefly describe the main idea of your project, its goals, and objectives.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'Description. Our app revolutionizes task management. Streamline ',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Montserrat',
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Describe potential market',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Forecast 5-year profit',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Specify investor\'s share',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Identify needed investment',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 0.0),
                                      child: Text(
                                        'Insert an image that visualizes the main problem your startup plans to solve',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 40.0, 0.0, 0.0),
                                      child: Text(
                                        'Provide a clear and concise definition of the problem you plan to solve',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 0.0),
                                      child: Text(
                                        'Present several ways in which your product or service can solve the aforementioned problem, and explain how exactly it will work',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                          ...
                                          builder: (context) {
                                            ...
                                            return Column(
                                              ...
                                              children: List.generate(
                                                      soliutions.length,
                                                      (soliutionsIndex) {
                                                final soliutionsItem =
                                                    soliutions[soliutionsIndex];
                                                return SolutionCardWidget(
                                                  key: Key(
                                                      'Key8x5_${soliutionsIndex}_of_${soliutions.length}'),
                                                  parameter1: soliutionsIndex,
                                                  title: soliutionsItem.title,
                                                  description: soliutionsItem
                                                      .description,
                                                  act: () async {
                                                    _model
                                                        .updateSolutionsAtIndex(
                                                      soliutionsIndex,
                                                      (e) => e,
                                                    );
                                                    setState(() {});
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      if (_model.businessModelChart == null ||
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 24.0, 0.0, 0.0),
                                child: Text(
                                  'Specify which type of business model you are using (B2B, B2C, B2G, etc.)',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Montserrat',
                                    ...
                                    Builder(
                                      builder: (context) {
                                        ...
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
                                          children:
                                              List.generate(cashflow.length,
                                                      (cashflowIndex) {
                                            final cashflowItem =
                                                cashflow[cashflowIndex];
                                            return BusinessModelCardWidget(
                                              key: Key(
                                                  'Keyf21_${cashflowIndex}_of_${cashflow.length}'),
                                              parameter1: cashflowIndex,
                                              cashflowName: cashflowItem.title,
                                              cashflowdescription:
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'Insert an image or graph that visualizes the projected financial growth of your company',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Montserrat',
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  'Describe anticipated financial growth',
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Description of the market',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'Insert a chart that displays market growth dynamics, or an image that symbolizes your industry and market',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Montserrat',
                                  ...
                                  if (false)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 0.0),
                                      child: Text(
                                        'Specify the key parameters for comparing your startup with your competitors',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                        ...
                                        builder: (context) {
                                          ...
                                          return Column(
                                            ...
                                            children: List.generate(
                                                ...
                                                (comparisonOptionsIndex) {
                                              final comparisonOptionsItem =
                                                  comparisonOptions[
                                                      comparisonOptionsIndex];
                                              return ComparisonOptionWidget(
                                                key: Key(
                                                    'Keyb72_${comparisonOptionsIndex}_of_${comparisonOptions.length}'),
                                                parameter1:
                                                    comparisonOptionsItem,
                                                index: comparisonOptionsIndex,
                                              );
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 12.0, 0.0, 0.0),
                                          child: Text(
                                            'Provide your main competitors for comparison',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Montserrat',
                                            ...
                                            builder: (context) {
                                              ...
                                              return Column(
                                                ...
                                                children: List.generate(
                                                    competitors.length,
                                                    (competitorsIndex) {
                                                  final competitorsItem =
                                                      competitors[
                                                          competitorsIndex];
                                                  return CompetitorNameWidget(
                                                    key: Key(
                                                        'Keykmd_${competitorsIndex}_of_${competitors.length}'),
                                                    parameter1: competitorsItem
                                                        .competitorName,
                                                    index: competitorsIndex,
                                                  );
                                                }).addToStart(
                                            ...
                                            return Column(
                                              ...
                                              children: List.generate(
                                                ...
                                                final competitorsItem =
                                                    competitors[
                                                        competitorsIndex];
                                                return CompetitorTestWidget(
                                                  key: Key(
                                                      'Keyq08_${competitorsIndex}_of_${competitors.length}'),
                                                  parameter1: competitorsIndex,
                                                  title: competitorsItem.title,
                                                  advantage: competitorsItem
                                                      .advantages,
                                                  disadvantage: competitorsItem
                                                      .disadvantages,
                                                );
                                              }).addToStart(
                                                  SizedBox(height: 12.0)),
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 12.0, 0.0, 0.0),
                                          child: Text(
                                            'Check the parameters that apply to your startup. If a certain parameter does not apply to your startup, leave the field empty',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Montserrat',
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 30.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Check the boxes for the parameters that the project has',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                                                          ...
                                                          children:
                                                            ...
                                                            return Column(
                                                              ...
                                                              children: [
                                                                OptionWidget(
                                                                  key: Key(
                                                                      'Keyn2c_${optsIndex}_of_${opts.length}'),
                                                                  text:
                                                                      optsItem,
                                                                  index:
                                                                      optsIndex,
                              ...
                              if (false)
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 12.0, 0.0, 0.0),
                                  child: Text(
                                    'Check the parameters that apply to your competitor. If a certain parameter does not apply to your competitor, leave the field empty',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Montserrat',
                                  ...
                                  builder: (context) {
                                    ...
                                    return Column(
                                      ...
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children:
                                          List.generate(competitors434.length,
                                              (competitors434Index) {
                                        final competitors434Item =
                                            competitors434[competitors434Index];
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
                                          crossAxisAlignment:
                                              CrossAxisAlignment.start,
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children:
                                          List.generate(competitors2.length,
                                              (competitors2Index) {
                                        final competitors2Item =
                                            competitors2[competitors2Index];
                                        return Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 35.0, 0.0, 0.0),
                                                          ...
                                                          return Column(
                                                            ...
                                                            children: List.generate(
                                                              ...
                                                              final myOptionsItem =
                                                                  myOptions[
                                                                      myOptionsIndex];
                                                              return ConcurentOptionWidget(
                                                                key: Key(
                                                                    'Keyact_${myOptionsIndex}_of_${myOptions.length}'),
                                                                text:
                                                                    myOptionsItem,
                                                                indexOption:
                                                                    myOptionsIndex,
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'Insert an image of your product or concept that can visualize the current status of your project or startup',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Montserrat',
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 12.0, 0.0, 0.0),
                                child: Text(
                                  'Describe your strategic plan for the next 5 years, indicating the key stages and objectives you plan to achieve each year',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Montserrat',
                                                    ...
                                                    return Column(
                                                      ...
                                                      children: List.generate(
                                                        ...
                                                        return Visibility(
                                                          ...
                                                          child: TaskWidget(
                                                            key: Key(
                                                                'Keyeyr_${tasksIndex}_of_${tasks.length}'),
                                                            parameter1:
                                                                tasksIndex,
                                                            year: 1,
                                                            text: tasksItem
                                                    ...
                                                    return Column(
                                                      ...
                                                      children: List.generate(
                                                        ...
                                                        return Visibility(
                                                          ...
                                                          child: TaskWidget(
                                                            key: Key(
                                                                'Keyfg3_${tasks2Index}_of_${tasks2.length}'),
                                                            parameter1:
                                                                tasks2Index,
                                                            year: 2,
                                                            text: tasks2Item
                                                    ...
                                                    return Column(
                                                      ...
                                                      children: List.generate(
                                                        ...
                                                        return Visibility(
                                                          ...
                                                          child: TaskWidget(
                                                            key: Key(
                                                                'Key7bj_${tasks3Index}_of_${tasks3.length}'),
                                                            parameter1:
                                                                tasks3Index,
                                                            year: 3,
                                                            text: tasks3Item
                                                    ...
                                                    return Column(
                                                      ...
                                                      children: List.generate(
                                                        ...
                                                        return Visibility(
                                                          ...
                                                          child: TaskWidget(
                                                            key: Key(
                                                                'Key71j_${tasks4Index}_of_${tasks4.length}'),
                                                            parameter1:
                                                                tasks4Index,
                                                            year: 4,
                                                            text: tasks4Item
                                                    ...
                                                    return Column(
                                                      ...
                                                      children: List.generate(
                                                        ...
                                                        return Visibility(
                                                          ...
                                                          child: TaskWidget(
                                                            key: Key(
                                                                'Keyc8w_${tasks5Index}_of_${tasks5.length}'),
                                                            parameter1:
                                                                tasks5Index,
                                                            year: 5,
                                                            text: tasks5Item
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'Write a brief but powerful message or call to action to secure investors\' attention and motivate them for further communication',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Montserrat',
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Message to investors',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'Indicate methods of communication and links to external resources',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Montserrat',
                  ...
                  child: Column(
                    ...
                    children: [
                      LinearPercentIndicator(
                        percent: _model.pageViewCurrentIndex.toDouble() / 7,
                        width: MediaQuery.sizeOf(context).width * 1.0,
                        lineHeight: 4.0,
                        animation: true,
                        animateFromLastPercent: true,
                        progressColor: FlutterFlowTheme.of(context).primary,
                        backgroundColor: Color(0x343DA5DE),
              ...
              Align(
                alignment: AlignmentDirectional(0.0, 1.0),
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 105.0),
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: BackdropFilter(
                      filter: ImageFilter.blur(
