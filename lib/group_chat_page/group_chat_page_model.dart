...
import 'group_chat_page_widget.dart' show GroupChatPageWidget;
...
class GroupChatPageModel extends FlutterFlowModel<GroupChatPageWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in group_chat_page widget.
  List<UsersRecord>? users;
  ChatsRecord? containerPreviousSnapshot;
