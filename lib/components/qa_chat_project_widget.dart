...
import 'qa_chat_project_model.dart';
export 'qa_chat_project_model.dart';

class QaChatProjectWidget extends StatefulWidget {
  const QaChatProjectWidget({
    super.key,
  ...
  @override
  State<QaChatProjectWidget> createState() => _QaChatProjectWidgetState();
}

class _QaChatProjectWidgetState extends State<QaChatProjectWidget>
    with TickerProviderStateMixin {
  late QaChatProjectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QaChatProjectModel());
