...
import 'company_small_card_model.dart';
export 'company_small_card_model.dart';

class CompanySmallCardWidget extends StatefulWidget {
  const CompanySmallCardWidget({
    super.key,
  ...
  @override
  State<CompanySmallCardWidget> createState() => _CompanySmallCardWidgetState();
}

class _CompanySmallCardWidgetState extends State<CompanySmallCardWidget> {
  late CompanySmallCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompanySmallCardModel());
              ...
              if (widget!.companyRef != null)
                Opacity(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 2.0, 10.0, 0.0),
                      child: Text(
                        valueOrDefault<String>(
                          widget!
                              .companyRef?.projectInformation?.shortDescription,
                          'company ',
                        ),
