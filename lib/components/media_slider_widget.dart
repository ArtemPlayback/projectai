...
import 'media_slider_model.dart';
export 'media_slider_model.dart';
...
class MediaSliderWidget extends StatefulWidget {
  ...
  @override
  State<MediaSliderWidget> createState() => _MediaSliderWidgetState();
}

class _MediaSliderWidgetState extends State<MediaSliderWidget> {
  late MediaSliderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MediaSliderModel());
