...
import 'information_company_model.dart';
export 'information_company_model.dart';

class InformationCompanyWidget extends StatefulWidget {
  const InformationCompanyWidget({
    super.key,
  ...
  @override
  State<InformationCompanyWidget> createState() =>
      _InformationCompanyWidgetState();
}

class _InformationCompanyWidgetState extends State<InformationCompanyWidget>
    with TickerProviderStateMixin {
  late InformationCompanyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InformationCompanyModel());
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, sectionsIndex) {
                            ...
                            return SectionWidget(
                              key: Key(
                                  'Keyupw_${sectionsIndex}_of_${sections.length}'),
                              index: sectionsIndex,
                            );
                          },
                        );
