...
import 'create_product_copy_model.dart';
export 'create_product_copy_model.dart';

class CreateProductCopyWidget extends StatefulWidget {
  const CreateProductCopyWidget({super.key});

  @override
  State<CreateProductCopyWidget> createState() =>
      _CreateProductCopyWidgetState();
}

class _CreateProductCopyWidgetState extends State<CreateProductCopyWidget>
    with TickerProviderStateMixin {
  late CreateProductCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateProductCopyModel());
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    _model.openai = await actions.openAIImages(
                                      _model.images.toList(),
                  ...
                  Padding(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            FFAppState().questions.length.toString(),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'LTSuperior',
                                ...
                                return Column(
                                  ...
                                  children: List.generate(questions3.length,
                                    ...
                                    return FormItemWidget(
                                      key: Key(
                                          'Keytke_${questions3Index}_of_${questions3.length}'),
                                      index: questions3Index,
