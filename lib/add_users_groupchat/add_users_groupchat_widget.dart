...
import 'add_users_groupchat_model.dart';
export 'add_users_groupchat_model.dart';

class AddUsersGroupchatWidget extends StatefulWidget {
  const AddUsersGroupchatWidget({
    super.key,
    required this.chat,
  });
  ...
  @override
  State<AddUsersGroupchatWidget> createState() =>
      _AddUsersGroupchatWidgetState();
}

class _AddUsersGroupchatWidgetState extends State<AddUsersGroupchatWidget> {
  late AddUsersGroupchatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddUsersGroupchatModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.usersAction = await actions.queryUsers(
        currentUserReference!,
        _model.chats!.toList(),
        widget!.chat?.users?.toList(),
      );
      _model.combinedUsersList =
          _model.usersAction!.toList().cast<DocumentReference>();
      safeSetState(() {});
      _model.querried = await queryUsersRecordOnce(
        queryBuilder: (usersRecord) => usersRecord.whereIn(
            'uid', _model.combinedUsersList.map((e) => e.id).toList()),
      );
      _model.query = _model.querried!.toList().cast<UsersRecord>();
      _model.usersList2 =
          widget!.chat!.users.toList().cast<DocumentReference>();
      safeSetState(() {});
    });
                              ...
                              decoration: InputDecoration(
                                ...
                                hintStyle: FlutterFlowTheme.of(context)
                                    ...
                                    .override(
                                      ...
                                      color:
                                          FlutterFlowTheme.of(context).a3a3b3,
                                      letterSpacing: 0.0,
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                if (_model.usersList2.contains(
                                                        usersItem.reference) ==
                                                    true) {
                                                  _model.removeFromUsersList2(
                                                      usersItem.reference);
                                                  safeSetState(() {});
                                                } else {
                                                  _model.addToUsersList2(
                                                      usersItem.reference);
                                                  safeSetState(() {});
                                                }
                                              },
                        ...
                        child: ButtonInfinityWidget(
                          ...
                          action: () async {
                            await widget!.chat!.reference.update({
                              ...mapToFirestore(
                                {
                                  'users': _model.usersList2,
                                },
                              ),
                            });
                            _model.groupchatusers =
